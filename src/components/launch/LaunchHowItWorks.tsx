...
const steps = [
  ...
  },
  {
    ...
    title: "Review & Launch",
    description:
      "Receive your project in 24–72 hours. One revision round included, then we ship it live.",
  },
];

export default function LaunchHowItWorks() {
  return (
    <section className="relative py-24 md:py-32 border-t border-white/5">
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 md:px-10">
        <FadeIn className="mb-16">
          ...
          <h2 className="text-3xl md:text-5xl font-semibold tracking-tighter max-w-[560px]">
